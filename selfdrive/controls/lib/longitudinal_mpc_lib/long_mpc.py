...
CRUISE_GAP_V = [0.8, 1.35, 1.65, 2.20]

#AUTO_TR_BP = [0., 30.*CV.KPH_TO_MS, 70.*CV.KPH_TO_MS, 110.*CV.KPH_TO_MS]
#AUTO_TR_V = [1.0, 1.2, 1.33, 1.45]
AUTO_TR_BP = [0., 20.*CV.KPH_TO_MS, 30.*CV.KPH_TO_MS, 70.*CV.KPH_TO_MS, 110.*CV.KPH_TO_MS]
AUTO_TR_V = [0.8, 0.97, 1.2, 1.4, 1.55]
...
MIN_ACCEL = -3.5
T_FOLLOW = 1.45
COMFORT_BRAKE = 2.4 # 2.5
STOP_DISTANCE = 5.6 # 6.25
