...
class CarInterface(CarInterfaceBase):
  ...
  def get_pid_accel_limits(CP, current_speed, cruise_speed):
    ...
    gas_max_bp = [0.,1., 10., 20., 50., 70., 130., 150.]
    gas_max_v = [1.2, 2.0,1.9,1.8, 1.4 , 0.52, 0.2, 0.1]
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=[], disable_radar=False):  # pylint: disable=dangerous-default-value
    ...
    ret.stopAccel = -0.01
    ret.stoppingDecelRate = 0.45  # brake_travel/s while trying to stop
    ...
    # hyundai
      ...
      ret.centerToFront = ret.wheelbase * 0.4
    elif candidate in [CAR.GRANDEUR_IG, CAR.GRANDEUR_IG_HEV, CAR.GRANDEUR_IG_HEV_2018]:
